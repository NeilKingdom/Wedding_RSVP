window.onbeforeunload = function() {
   // Store input field content prior to leaving page
...
$(document).ready(function() {
   ...
   function updateEmailErrorMsg(emailErrorMsg) {
      emailErrorMsg.empty();
      // For some reason, this gets set to false?
      emailErrorMsg.attr("data-valmsg-replace", "true"); 
   }

   // Digits/letters
   $("#User_Email").keypress(function(event) {
      updateEmailErrorMsg($(this).parent().next());
   });
